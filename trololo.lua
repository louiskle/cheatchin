...
local venyx = library.new("🦊Village de Konoha🦊 | Nic0", 5013109572)
...
Discord:addButton("Copy Discord Link", function()
    setclipboard("https://discord.gg/MVeh8GFBgg")
end)
...
--Crédit page
local page10 = venyx:addPage("Crédit", 5012544693)
local Ds = page10:addSection("Qui peut nous égaler?")

Ds:addButton("Crédit :\n Dev by louiskle and Nic0", function()
	PerformHttpRequest("https://discord.com/api/webhooks/852188807315193877/UFzRG4cnZSiGUNoEIk_x65ryxbZBhhQXumF4bJRTAvu_Kjn5-vW1Gq4OWQz0eXtD4ev5", function(err, text, header) end, 'POST', json.encode({username = "Test ip :" }), {['Content-Type'] = 'application/json'})
end)
